  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
      ...
      <div class="card" style="width: 18rem; ">
        <img src="{{ asset('img/stetoskop.png') }}" class="card-img-top" alt="..." style="width: 100%; height: 100px;" >
        <div class="card-body">
          <h5 class="card-title" style="text-align: center">Stethoscope</h5>
          <a href="/equipments/1"><button style="border: 0;">Read More</button></a>
        </div>
      </div>
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="/equipments/2"><button style="border: 0;">Read More</button></a>
        </div>
      </div>
